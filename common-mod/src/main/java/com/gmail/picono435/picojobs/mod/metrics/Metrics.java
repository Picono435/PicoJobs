package com.gmail.picono435.picojobs.mod.metrics;
...
public class Metrics {
     ...
     */
    public Metrics(int serviceId) throws IOException {
        // Get the config file
    ...
    private void appendPlatformData(JsonObjectBuilder builder) {
        builder.appendField("playerAmount", PicoJobsMod.getServer().get().getPlayerCount());
        builder.appendField("onlineMode", PicoJobsMod.getServer().get().usesAuthentication() ? 1 : 0);
